class Game {
  ...
  * Display score
   ...
   */
  showGrade(score) {
    if (score > 30) return "Chuck Norris es tu?";else
    if (score > 25) return "Ta tudo bem mano?";else
    if (score > 20) return "Duvido.";else
    if (score > 15) return "Ta tranquilo.";else
    if (score > 13) return "Ta fdd mano";else
    if (score > 10) return "Ta fixe.";else
    if (score > 5) return "A serio?";else
    return "MM PODRE...";
  }
